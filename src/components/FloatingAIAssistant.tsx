...
import { MessageSquare, Bot, User, Send, ExternalLink, Minimize2, Maximize2, X } from 'lucide-react';
...
export const FloatingAIAssistant = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Card className={`transition-all duration-300 shadow-xl ${isMinimized ? 'h-16' : 'h-96 w-80'}`}>
            ...
            <div className="border-t p-3">
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder="Ask about members, costs..."
                  className="flex-1 h-8 text-xs"
                />
                <Button onClick={handleSend} disabled={!inputValue.trim() || isTyping} size="sm" className="h-8 w-8 p-0">
